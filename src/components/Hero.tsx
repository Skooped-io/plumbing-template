...
const Hero = () => {
  const h1Text = seoConfig.seo.home.h1;
  ...
  return (
    <section className="relative overflow-hidden bg-secondary">
      <div className="absolute inset-0">
        <img
          src={getImage(null, 'hero', heroImage)}
      ...
      <div className="container relative mx-auto px-4 py-20 md:py-28 lg:py-36">
        <div className="max-w-2xl">
          ...
          >
            Licensed plumbers serving the {seoConfig.serviceArea.toLowerCase()}. Emergency service available 24/7 — we're always ready when you need us.
          </p>
          <a
